...
define view entity ZGKG_BOOKING as select from /dmo/booking_m

composition[0..*] of ZGKG_BOOKINGSUPPL as _BookingSuppl

association to parent ZGKG_TRAVEL as _Travel on
